...
class Token {
  ...
  public static
  function getCurrentTokenVar( $key ) {
   ...
   */
  public static
  function getCurrentIdentity( $keys ) {
    $token = Request::instance()
                    ->header( 'token' );
...
//        $identities = cache($token);
   ...
   */
  public static
  function isValidOperate( $checkedUID ) {
    if ( !$checkedUID ) {
