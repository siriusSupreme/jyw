      ...
      $this->viewReplaceStr = array_merge( $this->viewReplaceStr,
                                           [
                                             "__ADMIN_STATIC__"  => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static',
                                             "__ADMIN_JS__"      => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/js',
                                             "__ADMIN_CSS__"     => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/css',
                                             "__ADMIN_IMAGES__"  => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/images',
                                             "__ADMIN_FONTS__"   => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/fonts',
                                             "__ADMIN_LIBS__"    => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/libs',
                                             "__ADMIN_PLUGINS__" => $this->resourcePrefix
                                                                    . 'theme/admin/'.config('theme.admin_theme').'/public/static/plugins'
                                           ]);
