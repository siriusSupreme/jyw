...
/*网站根路径*/
defined( 'ROOT_PATH') or define( 'ROOT_PATH', dirname( APP_PATH).DIRECTORY_SEPARATOR);
...
defined( 'PARAM_PATH') or define( 'PARAM_PATH', RUNTIME_PATH.'param'.DIRECTORY_SEPARATOR);
